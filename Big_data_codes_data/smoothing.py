...
q = float(sys.argv[3]) # smoothing factor
...
for word in distinct_vocabulary:
	Prob_words_dict_liberal[word] = ((math.log(Distinct_words_dict_liberal[word] + q)) - \
							math.log(nliberal + q*Total_distinct_words))
...
# Probability
for word in distinct_vocabulary:
	Prob_words_dict_conservative[word] = ((math.log(Distinct_words_dict_conservative[word] + q)) - \
							math.log(nconservative + q*Total_distinct_words))
###	
